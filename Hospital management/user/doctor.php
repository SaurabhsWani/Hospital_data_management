    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Add New Doctor Member </h5>
          <button  type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="doctorcon.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" name="adddr" class="btn btn-primary">Save</button>
          </div>
        </form>
      </div>
    </div>
  </div>
  <!-- for adding a doctor end-->
  <!-- for editing a doctor -->
  <?php
      ...
      <div class="modal fade" id='<?php echo "ss".$row['id'];?>' tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form action="doctorcon.php" method="POST" enctype="multipart/form-data"><div class="modal-body">
              <div class="form-group">
                <label> Name </label>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
              <button type="submit" name="edit_dr" class="btn btn-primary">Save</button>
            </div>
          </form>
        </div>
      </div>
...
?>
<!-- for editing a doctor end-->
<div class="row ">
  <div class="col-md-12">
   <div class="card">
    <div class="card bg-secondary-gradient">
      <div class="card-header bubble-shadow">
        <h4 class="card-title" style="color: white">Doctor</h4>
      </div>
            ...
            while ($row=mysqli_fetch_assoc($sql)) {
              ...
              <tr>
                ...
                <td> 
                  ...
                  <td>
                    <form action="doctorcon.php" method="post">
                      <input type="hidden" name="del_id" value='<?php echo $row['id'];?>'>
                      <button <?php echo $dsblda;?> type="submit" name="del_dr" class="btn btn-icon btn-round btn-xs"><i class="fas fa-trash"></i>
                      </button>
                    </form>
                  </td>
                </tr>
